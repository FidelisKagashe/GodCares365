...
export default function Home() {
  ...
  const slides = [
  {
    ...
    subtitle:
      t('heroSubtitle1'),
    cta: { label: t('readMore'), link: '/community' },
  },
  {
    image: women,
    align: 'right',
    ...
    subtitle:
      t('heroSubtitle2'),
    cta: { label: t('learnMore'), link: '/bible-studies' },
  },
  {
    image: chinese,
    align: 'left',
    ...
    subtitle:
      t('heroSubtitle3'),
    cta: { label: t('viewEvents'), link: '/events' },
  },
];
        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
          ...
          <form className="w-full md:w-1/2 lg:w-1/3 flex">
            <input
              ...
              className={`w-full px-4 py-3 rounded-l-full border focus:outline-none focus:ring-2 transition-colors ${
                isDark 
                  ? 'bg-gray-700 border-gray-600 text-white focus:ring-yellow-400' 
                  : 'bg-white border-yellow-300 text-gray-900 focus:ring-yellow-400'
              }`}
            />
            <button
              type="submit"
              className="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-6 py-3 rounded-r-full transition-colors"
            >
              Jiunge
            </button>
          </form>
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/duka" className={`transition-colors ${
                  isDark ? 'hover:text-gray-100' : 'hover:text-white'
                }`}>{t('shop')}</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className={`mb-4 ${isDark ? 'text-gray-400' : 'text-gray-400'}`}>
